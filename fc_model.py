...
def train_model(model, trainloader, validloader, epochs, print_every, criterion, optimizer, device='cpu'):
    ...
    print("Training with {} pre-trained model || epochs={} || device={}.".format(model.__class__.__name__, epochs, device))
...
def check_accuracy_on_test(model, testloader):  
    ...
    print('Accuracy of the network on {} test images: {:.2f}%'.format(image_count, 100 * correct / total))
